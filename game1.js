                    ...
                    inputerBtn.addEventListener("click", function() {
                        if (InputTimes === 0 & Trials != 0) {
                            ...
                            if (wordmatch === theWord) {
                                if (localStorage.getItem("waterLevel") === null || localStorage.getItem("waterLevel") === "null") {
                                    localStorage.setItem("waterLevel", "2")
                                }
                                if (parseInt(localStorage.getItem("waterLevel")) < 2) {
                                    localStorage.setItem("waterLevel", "2")
                                }
