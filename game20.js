            ...
            setTimeout(function() {
                ...
                pagelinking(backLoseBtn, "game19");
                pagelinking(replayLoseBtn, "game20.html");
                ...
                pagelinking(nextWin, "../scene.html")
                    ...
                    inputerBtn.addEventListener("click", function() {
                        if (InputTimes === 0 & Trials != 0) {
                            ...
                            if (wordmatch === theWord) {
                                if (parseInt(localStorage.getItem("waterLevel")) < 21) {
                                    localStorage.setItem("waterLevel", "21")
                                }
