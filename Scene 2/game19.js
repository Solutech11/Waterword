            ...
            setTimeout(function() {
                ...
                pagelinking(backLoseBtn, "game18.html");
                pagelinking(replayLoseBtn, "game19.html");
                ...
                pagelinking(nextWin, "game20.html")
                ...
                function buttonWork(inputerBtn, inputholder) {
                    ...
                    inputerBtn.addEventListener("click", function() {
                        if (InputTimes === 0 & Trials != 0) {
                            ...
                            InputTimes = 0
                            wordmatch = Word1 + Word2 + Word3 + Word4 + Word5 + Word6 + Word7 + Word8;

                            if (wordmatch === theWord) {
                                if (parseInt(localStorage.getItem("waterLevel")) < 20) {
                                    localStorage.setItem("waterLevel", "20")
                                }
