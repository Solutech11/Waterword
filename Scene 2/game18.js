            ...
            setTimeout(function() {
                ...
                pagelinking(backLoseBtn, "game17.html");
                pagelinking(replayLoseBtn, "game18.html");
                ...
                pagelinking(nextWin, "game19.html")
                    ...
                    inputerBtn.addEventListener("click", function() {
                        if (InputTimes === 0 & Trials != 0) {
                            ...
                            if (wordmatch === theWord) {
                                if (parseInt(localStorage.getItem("waterLevel")) < 19) {
                                    localStorage.setItem("waterLevel", "19")
                                }
