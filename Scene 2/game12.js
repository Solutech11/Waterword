            ...
            setTimeout(function() {
                ...
                pagelinking(backLoseBtn, "game11.html");
                pagelinking(replayLoseBtn, "game12.html");
                ...
                pagelinking(nextWin, "game13.html")
                    ...
                    inputerBtn.addEventListener("click", function() {
                        if (InputTimes === 0 & Trials != 0) {
                            ...
                            if (wordmatch === theWord) {
                                if (parseInt(localStorage.getItem("waterLevel")) < 13) {
                                    localStorage.setItem("waterLevel", "13")
                                }
