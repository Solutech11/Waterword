            ...
            setTimeout(function() {
                ...
                var homeBtn = document.querySelector(".home"),
                    ...
                    characterTen = document.querySelector(".charTen"),
                    characterEleven = document.querySelector(".charEleven"),
                    characterTwelve = document.querySelector(".charTwelve"),
                ...
                pagelinking(replayLoseBtn, "Game9.html");
                ...
                pauseBtnm.addEventListener("click", function() {
                    ...
                    if (PauseDiv.style.display === "none") {
                        ...
                        inputerSevenBtn.disabled = false;
                        inputerEightBtn.disabled = false;
                        inputerNineBtn.disabled = false;
                        inputerTenBtn.disabled = false;
                        inputerElevenBtn.disabled = false;
                        inputerTwelveBtn.disabled = false;
                ...
                pagelinking(nextWin, "Game10.html")
                ...
                function buttonWork(inputerBtn, inputholder) {
                    ...
                    inputerBtn.addEventListener("click", function() {
                        if (InputTimes === 0 & Trials != 0) {
                            ...
                            word9 = inputholder;
                        }else if (InputTimes === 9 & Trials != 0) {
                            characterTen.innerHTML = inputholder;
                            InputTimes++
                            // console.log(InputTimes);

                            word10 = inputholder;
                        }else if (InputTimes === 10 & Trials != 0) {
                            characterEleven.innerHTML = inputholder;
                            InputTimes++
                            // console.log(InputTimes);

                            word11 = inputholder;
                        } else if (InputTimes === 11 & Trials != 0) {
                            InputTimes++
                            characterTwelve.innerHTML = inputholder;
                            ...
                            characterFour.innerHTML = inputholder;
                            InputTimes = 0
                            wordmatch = Word1 + Word2 + word3 + word4+ word5+word6+word7+word8+word9+word10+word11+word12;

                            if (wordmatch === theWord) {
                                if(parseInt(localStorage.getItem("waterLevel"))<30){
                                    localStorage.setItem("waterLevel", "30")
                                    }
                            ...
                            if (wordmatch != theWord) {
                                ...
                                characterTen.innerHTML = ""
                                characterTwelve.innerHTML=""
                                characterEleven.innerHTML=""
