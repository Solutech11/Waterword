            ...
            setTimeout(function() {
                ...
                pagelinking(replayLoseBtn, "Game8.html");
                ...
                pagelinking(nextWin, "Game9.html")
                    ...
                    inputerBtn.addEventListener("click", function() {
                        if (InputTimes === 0 & Trials != 0) {
                            ...
                            if (wordmatch === theWord) {
                                if(parseInt(localStorage.getItem("waterLevel"))<29){
                                    localStorage.setItem("waterLevel", "29")
                                    }
