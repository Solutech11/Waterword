            ...
            setTimeout(function() {
                ...
                pagelinking(replayLoseBtn, "Game6.html");
                ...
                pagelinking(nextWin, "Game7.html")
                ...
                function buttonWork(inputerBtn, inputholder) {
                    ...
                    inputerBtn.addEventListener("click", function() {
                        if (InputTimes === 0 & Trials != 0) {
                            ...
                            characterFour.innerHTML = inputholder;
                            InputTimes = 0
                            wordmatch = Word1 + Word2 + word3 + word4+ word5+word6+word7+word8+word9+word10;

                            if (wordmatch === theWord) {
                                if(parseInt(localStorage.getItem("waterLevel"))<27){
                                    localStorage.setItem("waterLevel", "27")
                                    }
