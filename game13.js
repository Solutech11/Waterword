            ...
            setTimeout(function() {
                ...
                pagelinking(backLoseBtn, "game12.html");
                pagelinking(replayLoseBtn, "game13.html");
                ...
                pagelinking(nextWin, "game14.html")
                    ...
                    inputerBtn.addEventListener("click", function() {
                        if (InputTimes === 0 & Trials != 0) {
                            ...
                            if (wordmatch === theWord) {
                                if (parseInt(localStorage.getItem("waterLevel")) < 14) {
                                    localStorage.setItem("waterLevel", "14")
                                }
