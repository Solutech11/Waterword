            ...
            setTimeout(function() {
                ...
                pagelinking(backLoseBtn, "game13.html");
                pagelinking(replayLoseBtn, "game14.html");
                ...
                pagelinking(nextWin, "game15.html")
                    ...
                    inputerBtn.addEventListener("click", function() {
                        if (InputTimes === 0 & Trials != 0) {
                            ...
                            if (wordmatch === theWord) {
                                if (parseInt(localStorage.getItem("waterLevel")) < 15) {
                                    localStorage.setItem("waterLevel", "15")
                                }
