            ...
            setTimeout(function() {
                ...
                pagelinking(backLoseBtn, "game15.html");
                pagelinking(replayLoseBtn, "game16.html");
                ...
                pagelinking(nextWin, "game17.html")
                    ...
                    inputerBtn.addEventListener("click", function() {
                        if (InputTimes === 0 & Trials != 0) {
                            ...
                            if (wordmatch === theWord) {
                                if (parseInt(localStorage.getItem("waterLevel")) < 17) {
                                    localStorage.setItem("waterLevel", "17")
                                }
